...
--lib ptm-search-data/data/library_filtered_database/in_silico_library_filtered_5mods_m_oxid.predicted.speclib \
--out ptm-search-data/results_thesis/dia_nn_results_filtered/report_filtered_5mods_together_m_oxid_all_spectra.tsv \
